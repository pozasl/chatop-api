...
public class FileStorageServiceImpl implements FileStorageService {
   ...
   * @return A unique generated file name
   * @throws FileUploadException throwed when the file name or extension isn't allowed
   */
   ...
   * @throws FileStorageException throwed if the path parent isn't the upload folder
   */
